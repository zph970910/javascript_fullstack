  ...
  <div class="left clearfix">
    <ul class="articles-list" id="list" >
      <transition-group name="el-fade-in" >
        <li class="item" v-for="(item, index) in articleeList" :key="index">
...
export default class Article extends Vue {
  private articleeList: Array<object> = []
  ...
  private async handleSearch(): Promise<void> {
    ...
    console.log(data)
    if (data.list.length) {
      this.articleeList = [...this.articleeList, ...data.list]
    }

    this.$nextTick(() => { // dom结构完全渲染之后执行
      lazyload()
    })
  }
}
